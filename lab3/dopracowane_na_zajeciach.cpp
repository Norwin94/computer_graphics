...
static GLfloat angle2rad;     // przelicznik pikseli na stopnie

static GLint status = 0;       // stan klawiszy myszy 
static GLint status1 = 0; 	   // 0 - nie naciœniêto ¿adnego klawisza
...
void RenderScene(void)
{
	...
	if (status == 1)                     // jeœli lewy klawisz myszy wciêniêty
	{
		...
		//cout << "azymut: " << azymut << endl << "elewacja: " << elewacja << endl;
